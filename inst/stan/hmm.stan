...
data {
  ...
  array[T] int<lower=0,upper=ntlc> tlcid; // which of these combinations each observation corresponds to (or zero, i.e. NA, if first observation per subject)
