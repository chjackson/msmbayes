...
vunirootRcpp <- function(f, lower, upper, fa, fb, numiter, tol) {
    .Call(`_msmbayes_vunirootRcpp`, f, lower, upper, fa, fb, numiter, tol)
}
...
## RcppExport SEXP _msmbayes_vunirootRcpp(SEXP fSEXP, SEXP lowerSEXP, SEXP upperSEXP, SEXP faSEXP, SEXP fbSEXP, SEXP numiterSEXP, SEXP tolSEXP) {
## BEGIN_RCPP
