...
#include "stanExports_phaseapprox.h"

RCPP_MODULE(stan_fit4phaseapprox_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_phaseapprox")
